...
if "password" not in st.session_state:
    ...
    # Persist the issued code (hashed) so we can classify expired vs invalid
...
if st.button("Report In"):
    ...
    # Determine outcome first so we can log it consistently.
    if correctPassword:
        outcome = "duplicate"
    else:
        # Prefer DB-backed validation (handles "old code" vs truly invalid).
        ...
        # Extra safety fallback when DB isn't configured.
